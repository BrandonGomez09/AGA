...
export default function ResumenOrden() {
    ...
    useEffect(()=>{
        const compra = localStorage.getItem("carrito");
        setCarrito(compra);
    },[]);
    ...
    return (
        <>
            <main className="relative lg:min-h-full">
                <div className="h-96 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
                    <img
                ...
                <div>
                    <div className="mx-auto max-w-2xl py-16 px-4 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-16 xl:gap-x-24">
                        <div className="lg:col-start-2">
                            ...
                            <p className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">¡Gracias por ordenar!</p>
